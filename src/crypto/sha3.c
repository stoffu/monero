// Implemented by the Keccak Team: https://github.com/KeccakTeam/KeccakCodePackage/blob/master/Standalone/CompactFIPS202/C/Keccak-more-compact.c
...
void sha3(const void *data, size_t length, char *hash) { FIPS202_SHA3_256((const u8 *)data, (u64)length, (u8 *)hash); }
